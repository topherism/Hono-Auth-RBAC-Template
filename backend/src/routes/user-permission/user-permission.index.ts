...
import * as handlers from "./user-permission.handler";
import * as routes from "./user-permission.routes";
...
// Public route
router.use("/user-permissions/*", authenticationMiddleware, userRateLimiter);
